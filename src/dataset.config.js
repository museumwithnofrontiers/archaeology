...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'archaeology',
  ...
  home: {
    title: 'archaeology.identity.title',
    intro: 'archaeology.home.intro',
    cards: [
      {
        title: 'archaeology.nav.catalogue',
        description: 'archaeology.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'archaeology.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'archaeology.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'archaeology.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //       partnerObjects: {
  //         emptyPartner: 'archaeology.partnerObjects.emptyPartner',
  //         emptyInstitution: 'archaeology.partnerObjects.emptyInstitution',
  //         institutionSummary: 'archaeology.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'archaeology.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'archaeology.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
